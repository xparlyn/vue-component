		...
		methods: {
			getAllColumns: function(columns) {
				...
				columns.forEach(function(column) {
					if (column.children) {
						result.push(column);
						result.push.apply(result, self.getAllColumns(column.children));
					} else {
						result.push(column);
					}
				});
